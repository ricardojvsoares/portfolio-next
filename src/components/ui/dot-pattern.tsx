...
export function DotPattern({
  ...
  return (
    <div
      ref={containerRef}
      className={cn('bg-background relative min-h-screen overflow-hidden', className)}
    >
      ...
      <div
        ...
        style={{
          background:
            'radial-gradient(ellipse at center, transparent 0%, transparent 40%, color-mix(in srgb, var(--background) 60%, transparent) 100%)',
        }}
      />
